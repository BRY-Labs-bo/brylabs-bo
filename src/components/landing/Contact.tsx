    ...
    <section id="contacto" className="py-24 md:py-32">
        ...
        <div className="mt-14 grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="space-y-4">
            <a
              ...
              className="group flex items-center gap-4 rounded-xl border border-border bg-card p-5 hover:bg-primary-soft hover:border-primary/30 transition-all"
            >
              <span className="flex h-11 w-11 items-center justify-center rounded-lg bg-primary-soft text-primary group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center rounded-md bg-primary px-5 py-3 text-sm font-medium text-primary-foreground hover:bg-primary-hover transition-colors"
            >
              Enviar mensaje
            </button>
            ...
            {sent && (
              <p
                role="status"
                className="text-sm text-primary text-center animate-reveal"
              >
      ...
      <style>{`
        ...
        .form-input:focus {
          ...
          box-shadow: 0 0 0 3px oklch(0.55 0.22 264 / 0.12);
        }
